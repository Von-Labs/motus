...
export class TapestryService {
  ...
  static async findOrCreateProfile(
    ...
    return tapestryRequest<FindOrCreateProfileResponse>(
  ...
  static async getProfileById(id: string): Promise<GetProfileDetailsResponse> {
  ...
  static async updateProfile(
    ...
    return tapestryRequest<Profile>(`/profiles/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(params),
    });
  }
  ...
  static async getProfileWallets(id: string) {
    return tapestryRequest(`/profiles/${encodeURIComponent(id)}/wallets`);
  }
  ...
  static async sendNotification(id: string, params: SendNotificationParams) {
    return tapestryRequest(`/profiles/${encodeURIComponent(id)}/notification`, {
      method: "POST",
      body: JSON.stringify(params),
    });
  }
  ...
  static async getProfileContacts(id: string) {
    return tapestryRequest(`/profiles/${encodeURIComponent(id)}/contacts`);
  }
  ...
  static async updateContent(
    ...
    return tapestryRequest<Content>(`/contents/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(params),
    });
  }
  ...
  static async deleteContent(id: string) {
    return tapestryRequest(`/contents/${encodeURIComponent(id)}`, {
      method: "DELETE",
    });
  }
  ...
  static async updateComment(
    ...
    return tapestryRequest<Comment>(`/comments/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(params),
    });
  }
  ...
  static async deleteComment(id: string) {
    return tapestryRequest(`/comments/${encodeURIComponent(id)}`, {
      method: "DELETE",
    });
  }
  ...
  static async createLike(nodeId: string, startId: string) {
    return tapestryRequest(`/likes/${encodeURIComponent(nodeId)}`, {
      method: "POST",
